...
def black_box_function(mid, balzer, bias):  #Harvey
    ...
    print(f'going from {mid0:.2f} to {mid:.2f} | {balzer0:.2f} to {balzer:.2f} | {bias0:.2f} to {bias:.2f}')
    venus.change_something('bias_v',bias)
    venus.change_something('gas_balzer_2',12.0)
    while(venus.read_something('gas_balzer_2')>12.1):
        time.sleep(0.37)
    venus.change_something('gas_balzer_2',balzer)
